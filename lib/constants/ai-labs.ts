...
export const AI_LABS_HERO = {
  ...
  description:
    "Novizco AI Labs helps clients explore, design, and implement AI solutions. We guide businesses through AI strategy, development, and integration - enabling you to adopt and scale AI with confidence.",
};
